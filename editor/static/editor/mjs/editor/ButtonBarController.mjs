...
class ButtonBarController {
    ...
    async initialize() {
        ...
        try {
            ...
            this.logger.error('Failed to initialize button bar', { error: error.message });
            return false;
        }
    }
    ...
    show() {
        ...
        if (this.isVisible) {
            this.logger.debug('Button bar already visible');
            return true;
        }
        ...
        try {
            this.buttonBar.show();
            this.isVisible = true;
            this.logger.debug('Button bar shown');
            return true;
    ...
    hide() {
        ...
        if (!this.isVisible) {
            this.logger.debug('Button bar already hidden');
            return true;
        }
        ...
        try {
            this.buttonBar.hide();
            this.isVisible = false;
            this.logger.debug('Button bar hidden');
            return true;
    ...
    showWithDelay(delay = 100) {
        ...
        this.logger.debug('Scheduled button bar show', { delay });
        return true;
    }
    ...
    hideWithDelay(delay = 100) {
        ...
        this.logger.debug('Scheduled button bar hide', { delay });
        return true;
    }
    ...
    _canShow() {
        ...
        if (!this.config.get('buttonBar.showOnFocus')) {
            this.logger.debug('Button bar show on focus disabled');
            return false;
        }
    ...
    _canHide() {
        ...
        if (!this.config.get('buttonBar.hideOnBlur')) {
            this.logger.debug('Button bar hide on blur disabled');
            return false;
        }
    ...
    forceShow() {
        ...
        try {
            this.buttonBar.show();
            this.isVisible = true;
            this.logger.debug('Button bar force shown');
            return true;
        } catch (error) {
            this.logger.error('Failed to force show button bar', { error: error.message });
            return false;
        }
    }
    ...
    forceHide() {
        ...
        try {
            this.buttonBar.hide();
            this.isVisible = false;
            this.logger.debug('Button bar force hidden');
            return true;
        } catch (error) {
            this.logger.error('Failed to force hide button bar', { error: error.message });
            return false;
        }
    }
    ...
    updateConfig(newConfig) {
        ...
        this.logger.debug('Button bar configuration updated', newConfig);
    }
    ...
    clearPendingOperations() {
        ...
        this.logger.debug('Cleared pending button bar operations');
    }
     ...
     */
    cleanup() {
        this.logger.debug('Starting button bar controller cleanup');
        ...
        if (this.isVisible && this.buttonBar) {
            try {
                ...
                this.logger.warn('Error hiding button bar during cleanup', { error: error.message });
            }
        }
     ...
     */
    async reinitialize() {
        this.logger.debug('Reinitializing button bar controller');
