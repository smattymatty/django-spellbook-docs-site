...
from ..models import (
    StoredMarkdown,
)  # Adjust import if your tests.py is elsewhere
...
class StoredMarkdownModelSaveTests(TestCase):
    def test_markdown_to_html_conversion_on_save(
        self,
    ):
    ...
    def test_script_tag_in_markdown_is_stripped_before_render(
        self,
    ):
    ...
    def test_allowed_html_in_markdown_is_preserved_before_render(
        self,
    ):
        ...
        md_content = (
            "This is <p><strong>allowed raw HTML</strong></p> in Markdown."
        )
        ...
        self.assertIn(
            "<p><strong>allowed raw HTML</strong></p>",
            stored_item.html_content,
        )
    ...
    def test_disallowed_html_in_markdown_is_stripped_before_render(
        self,
    ):
        ...
        self.assertIn(
            "A div that should not be stripped.",
            stored_item.html_content,
        )  # Content of stripped tags
        self.assertIn(
            "A span.",
            stored_item.html_content,
        )  # Content of stripped tags

    def test_spellbook_tag_processed_after_markdown_bleach(
        self,
    ):
        """
        ...
        md_content_spell_safe = (
            'Content with {~ some_spell parameter="value" ~}spell text{~~}.'
        )
        ...
        with patch(
            "api.models.render_spellbook_markdown_to_html"
        ) as mock_render:
            ...
            expected_bleached_markdown = (
                "A spell {~ myspell ~}inner content{~~} and bad afterwards."
            )
            self.assertEqual(
                received_markdown,
                expected_bleached_markdown,
    ...
    def test_update_markdown_content_rerenders_html(
        self,
    ):
