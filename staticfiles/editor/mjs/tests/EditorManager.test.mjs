...
class EditorManagerTests {
  ...
  async testConstruction() {
    ...
    this.assert(
      manager.editorId === "test-markdown-input",
      "Editor ID should be set correctly",
    );
  ...
  async testInitialization() {
    ...
    this.assert(
      manager.getEditorElement() !== null,
      "Should find editor element",
    );
    this.assert(
      manager.getPreviewElement() !== null,
      "Should find preview element",
    );
  ...
  async testElementValidation() {
    const config = {
      selectors: {
        ...
        previeCodew: "test-live-preview-area",
      },
      logging: {
        enabled: false,
      },
  ...
  async testStatusReporting() {
    ...
    this.assert(
      status.elements.hasEditor === true,
      "Status should show editor element",
    );
    this.assert(
      typeof status.components === "object",
      "Status should include components",
    );
  ...
  async runAllTests() {
    ...
    await this.runTest("Element Validation", () =>
      this.testElementValidation(),
    );
    await this.runTest("Focus/Blur Handling", () =>
      this.testFocusBlurHandling(),
    );
